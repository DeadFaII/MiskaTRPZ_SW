...
class MusicsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create music" do
    assert_difference("Music.count") do
      post musics_url, params: { music: { isFree: @music.isFree, musicDescription: @music.musicDescription, musicName: @music.musicName, musicText: @music.musicText, publishDate: @music.publishDate } }
    end
  ...
  test "should update music" do
    patch music_url(@music), params: { music: { isFree: @music.isFree, musicDescription: @music.musicDescription, musicName: @music.musicName, musicText: @music.musicText, publishDate: @music.publishDate } }
