...
class MusicsTest < ApplicationSystemTestCase
  ...
  test "should create music" do
    ...
    check "Isfree" if @music.isFree
    fill_in "Musicdescription", with: @music.musicDescription
    fill_in "Musicname", with: @music.musicName
    fill_in "Musictext", with: @music.musicText
    fill_in "Publishdate", with: @music.publishDate
